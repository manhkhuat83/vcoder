...
class Project(models.Model):
    ...
    demo_link = models.CharField(max_length=2000, null=True, blank=True, verbose_name='Nguồn thử nghiệm')
    source_link = models.CharField(max_length=2000, null=True, blank=True, verbose_name='Mã nguồn')
