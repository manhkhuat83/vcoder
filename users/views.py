...
def registerUser(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(
                request, 'Gặp phải lỗi phát sinh trong quá trình đăng ký!')
...
def createSkill(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            skill.owner = profile
            skill.save()
            messages.success(request, 'Thêm kỹ năng thành công!')
            return redirect('account')
    context = {'form': form}
...
def updateSkill(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, 'Cập nhật kỹ năng thành công!')
            return redirect('account')
    context = {'form': form}
    return render(request, 'users/skill_form.html', context)
...
def deleteSkill(request, pk):
    ...
    if request.method == 'POST':
        skill.delete()
        messages.success(request, 'Xóa kỹ năng thành công!')
        return redirect('account')
